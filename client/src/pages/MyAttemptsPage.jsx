// client/src/pages/MyAttemptsPage.jsx
...
export default function MyAttemptsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 min-h-screen pt-8">
      <h1 className="text-3xl font-bold text-white mb-2">My Attempts</h1>
      <p className="text-slate-400 mb-8">History of assessments you have completed.</p>
      ...
      {submissions.length === 0 ? (
        <div className="text-center py-20 border border-white/10 rounded-2xl bg-white/5">
          ...
          <h3 className="text-xl text-white font-semibold">No attempts yet</h3>
