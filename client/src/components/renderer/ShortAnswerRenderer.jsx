const ShortAnswerRenderer = ({ question, onAnswerChange, savedAnswer }) => {
  ...
  return (
    <div className="p-8 rounded-2xl shadow-xl border bg-slate-900 border-pink-500/20 relative overflow-hidden">
      ...
      <input
        ...
        placeholder="Type your answer here..." value={savedAnswer || ''} onChange={(e) => onAnswerChange(question._id, e.target.value)}
      />
    </div>
  );
};
